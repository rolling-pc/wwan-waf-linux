...
int main(int argc, char *argv[])
{
    ...
    LogConfig log_cfg;
    Logger::Instance().Init(CUSTOM | LINUX_SYSLOG | WINDOWS_EVENTLOG, "wwan_dev_service", log_cfg);
    ...
    LOG_INFO("------------------ starting dev service V%s-----------------",WWAN_DEV_VERSION_STRING);
    WwanDevSvc::startWwanDevServiceWork();

    int res = app.exec();
    WwanDevSvc::stopWwanDevServiceWork();
    QCoreApplication::quit();
