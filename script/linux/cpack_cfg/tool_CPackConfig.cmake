...
if(INSTALL_SERVICE_ENABLE)
    set(CPACK_PACKAGE_NAME "wwan-tools-${PROJECT}-${CURRENT_OEM}")
...
elseif(INSTALL_TOOLS_ENABLE)
    if(CMAKE_BUILD_TYPE STREQUAL "Debug")
        set(CPACK_PACKAGE_NAME "wwan-toolkits-debug")
    else()
        set(CPACK_PACKAGE_NAME "wwan-toolkits")
    endif()
    set(CPACK_PACKAGE_VERSION "1.0.21")
    set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "wwan-toolkits")
...
if("${CURRENT_PACKAGE_TYPE}" STREQUAL "deb")
    ...
    set(CPACK_DEBIAN_PACKAGE_DESCRIPTION  "WWAN Linux wwan_tool")
    set(CPACK_DEBIAN_PACKAGE_SECTION "net")
    set(CPACK_DEBIAN_PACKAGE_SECTION "base")
    set(CPACK_DEBIAN_PACKAGE_PRIORITY "standard")
    set(CPACK_DEBIAN_PACKAGE_ARCHITECTURE "amd64")
    set(CPACK_DEBIAN_PACKAGE_MAINTAINER "waf")
    set(CPACK_DEBIAN_PACKAGE_MAINTAINER "test <test@rolling.com>")
    set(CPACK_DEBIAN_PACKAGE_CONTROL_EXTRA
        "${PROJECT_SOURCE_DIR}/script/linux/cpack_source/debian_rpm/tools/preinst;"
        "${PROJECT_SOURCE_DIR}/script/linux/cpack_source/debian_rpm/tools/prerm;"
        "${PROJECT_SOURCE_DIR}/script/linux/cpack_source/debian_rpm/tools/postinst;"
        "${PROJECT_SOURCE_DIR}/script/linux/cpack_source/debian_rpm/tools/postrm"
    )
elseif("${CURRENT_PACKAGE_TYPE}" STREQUAL "rpm")
    # set(CPACK_RPM_PACKAGE_REQUIRES "libc6 >= 2.4")
    set(CPACK_GENERATOR "RPM")
    set(CPACK_RPM_FILE_NAME RPM-DEFAULT)
    set(CPACK_RPM_PACKAGE_SUMMARY "WWAN Linux wwan_tool")
    set(CPACK_RPM_PACKAGE_DEBUG FALSE)
    set(CPACK_RPM_PACKAGE_ARCHITECTURE "x86_64")
    set(CPACK_RPM_PACKAGE_GROUP "Applications/Internet")
    set(CPACK_RPM_PACKAGE_DESCRIPTION "WWAN Linux wwan_tool")
